...
public class ElizaEngine {
    ...
    private void initializeData() {
        ...
        int[] starts = {1,4,6,10,14,17,20,22,25,28,28,32,35,40,40,40,40,40,40,49,51,55,59,63,63,64,69,74,76,80,83,90,93,99,106};
        int[] lengths = {3,2,4,2,4,3,3,2,3,4,4,3,5,9,9,9,9,9,9,2,4,4,4,1,1,5,5,2,4,3,7,3,6,7,6};
